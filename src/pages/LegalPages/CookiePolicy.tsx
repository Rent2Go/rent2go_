        ...
        <div className="secContainer">
          <div className="tabs_list">
            <ul>
              ...
              <li><a href="#item-2">Type of Cookies We Use</a></li>
              <li><a href="#item-3">Your Choices Regarding Cookies</a></li>
              <li><a href="#item-4">More Information about Cookies</a></li>
              <li><a href="#item-5">Contact Us</a></li>
            </ul>
          </div>
          <div className='tabs_content'>
            ...
            <div className='tab_body'>
              ...
              <p id="item-1">We do not store sensitive personal information, such as mailing addresses, account passwords, etc. in the Cookies We use.</p>
              ...
              <ul>
                <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Rent2Go.</li>
                <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                <li><strong>Website</strong> refers to Rent2Go, accessible from <a href="https://rentogo.com.tr/" rel="external nofollow noopener" target="_blank">https://rentogo.com.tr/</a></li>
                <li id="item-2"><strong>You</strong> means the individual accessing or using the Website, or a company, or any legal entity on behalf of which such individual is accessing or using the Website, as applicable.</li>
              </ul>
              ...
              <p id="item-4">For any other web browser, please visit your web browser's official web pages.</p>
              <h2>More Information about Cookies</h2>
              <p id="item-5">You can learn more about cookies: <a href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank">Cookies: What Do They Do?</a>.</p>
              <h2>Contact Us</h2>
