...
const UpdateUser = (props: Props) => {
  ...
  const updateUserValidationSchema = object({
    ...
    phoneNumber: string()
      ...
      .matches(/^05\d{9}$/, "Phone number must be in the format 05xxxxxxxxx."),
    email: string()
  ...
  const handleCityChange = (selectedCity: number) => {
    ...
    const selectedCityDistrict = districts.filter(
      (district: DistrictModel) => district.city.name === city?.name
    );
              ...
              <div className="row">
                  ...
                  <Field name="districtId" as="select" className="form-control">
                    {user.district && (
                      <option key={user.district.id} value={user.district.id}>
                        {user.district.districtName.toUpperCase()}
                      </option>
                    )}
                ...
                <div className="col-xl-4 col-l-4 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <Field as="select" name="role" className="form-control">
                    <option key={user.role} value={user.role.toUpperCase()}>
